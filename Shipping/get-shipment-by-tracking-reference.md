# COURIER GUY – Get shipping by Tracking Reference

- You need to be logged inside of session-server to be able to test.

## Endpoint
**GET**  
`http://192.168.110.164:8823/Shipping/GetShipmentsByTrackingReference?trackingReference={tracking_reference}`

## Purpose
Retrieves shipment details associated with a specific tracking reference.
This endpoint is used to track, inspect, and validate the current status and full shipment information throughout the delivery lifecycle.
    ...
    "shipments": [
        {
            ...
            "latest_tracking_event_time": "2026-01-14T00:42:51.816751Z",
            "time_created": "2026-01-14T00:42:51.508297Z",
            "time_modified": "2026-01-14T00:42:51.884727Z",
            ...
            "proof_of_delivery_pin_hashed": "/eEqAfFI49Omv8VM8rfsOg5aLgcbGfAPWJkcMotLqag=",
            "collected_date": null,
            ...
            "rating_reference": "6acf448e-0a4c-4e8e-8242-bfcb902f0c67",
            "has_rating": false,
            ...
            "priority_level": 0,
            "payment_reference": "a64e49db-66ff-409c-a6a3-a313c779600a",
            "submitted_date": "2026-01-14T00:42:51.806283Z",
            "provider": {
                "name": null,
                "time_created": null,
                "invoice_counter": 0,
            ...
            "parcels": [
                {
                    ...
                    "time_created": "2026-01-14T00:42:51.533171Z",
                    "time_modified": "2026-01-14T00:42:51.864692Z"
                }
            ],
            ...
            "Rates": [
                {
                    ...
                    "vat_percentage": null,
                    "vat_type": "standard",
                    "valid_from": "2026-01-14T00:42:51.747222Z",
                    "valid_until": null,
                    "is_opt_in": false,
                    "is_custom_charge": false,
                    "is_quantity_based_charge": false,
                    "quantity": 0,
                    "billing_transaction_id": 101928841,
                    "metadata": {
                        "shipment_tracking_reference": "FV4XVM",
                        "service_level_code": "ECO",
                        "parcels": [
                            {
                                "id": 112677125,
                                ...
                                "has_been_dimensioned": false,
                                "time_created": "2026-01-14T00:42:51.533171Z",
                                "time_modified": "0001-01-01T00:00:00"
                            }
                        ],
                        "charged_weight": 2,
                        "estimated_weight": 2,
...
https://www.shiplogic.com/api-docs/get-getting-shipments